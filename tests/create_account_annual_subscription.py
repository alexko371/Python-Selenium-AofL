...
def test_create_annual_subscription_boy_and_girl(app):
    ...
    app.sign_up.submit_and_confirm_email("alex03@ep.test")  ##### Change Email Credentials!
    ...
    app.onboarding.create_child_profile(child_name="Alex(alex03)", gender="M", academic_level="toddler-time")
...
def test_create_annual_subscription_girl_and_boy(app):
    app.sign_up.open_abcmouse_web_page("https://ep.qtest.abcmouse.com/abt/subscription")  # Update URL QTEST!
    app.sign_up.submit_and_confirm_email("alex003@ep.test")  ##### Change Email Credentials!
    app.sign_up.submit_and_confirm_password("test123")
    app.credit_info.submit_cc_qtest(cardholder="Test Alex Ko", code_cvv="1234", zip_code="12345")
    ...
    app.onboarding.input_parent_name(parent_first_name="AK Test", parent_family_name="Ko Test")
    ##### (grade Levels' IDs: [toddler-time] [preschool] [pre-k] [kindergarten] [first-grade] [second-grade]
    app.onboarding.create_child_profile(child_name="G1 (alex003)", gender="F", academic_level="toddler-time")
...
def test_create_annual_subscription_with_assessment_boy_and_girl(app):
    app.sign_up.open_abcmouse_web_page("https://ep.qtest.abcmouse.com/abt/subscription")  # Update URL QTEST!
    app.sign_up.submit_and_confirm_email("alex0003@ep.test")  ##### Change Email Credentials!
    app.sign_up.submit_and_confirm_password("test123")
    app.credit_info.submit_cc_qtest(cardholder="Test Alex Ko", code_cvv="1234", zip_code="12345")
    ...
    app.onboarding.input_parent_name(parent_first_name="AK Test", parent_family_name="Ko Test")
    ##### (grade Levels' IDs: [toddler-time] [preschool] [pre-k] [kindergarten] [first-grade] [second-grade]
    app.onboarding.create_child_profile(child_name="B-1(alex0003)", gender="M", academic_level="preschool")
...
def test_create_annual_subscription_with_assessment_girl_and_boy(app):
    app.sign_up.open_abcmouse_web_page("https://ep.qtest.abcmouse.com/abt/subscription")  # Update URL QTEST!
    app.sign_up.submit_and_confirm_email("alex000003@ep.test")  ##### Change Email Credentials!
    app.sign_up.submit_and_confirm_password("test123")
    app.credit_info.submit_cc_qtest(cardholder="Test Alex Ko", code_cvv="1234", zip_code="12345")
    ...
    app.onboarding.input_parent_name(parent_first_name="AK Test", parent_family_name="Ko Test")
    ##### (grade Levels' IDs: [toddler-time] [preschool] [pre-k] [kindergarten] [first-grade] [second-grade]
    app.onboarding.create_child_profile(child_name="G-1(alex000003)", gender="F", academic_level="pre-k")
