...
def test_01_create_free_teacher_account(app):
    ...
    app.free_teacher.open_teacher_registration_page("https://dn.qtest.abcmouse.com/teacher-registration")  # Update URL QTEST!
    app.free_teacher.input_name(fname="AK Test", lname="(Free Teacher)")
    app.free_teacher.submit_email("ft1@dn.test")
    ...
    app.students.create_boy_toddler(name="St-1 (Boy)", birthday="07/2017")
    app.students.create_girl_preschool(name="St-2 (Girl)", birthday="01/2016")
    # app.students.create_boy_preschool(name="St-2 (Boy)", birthday="05/2016")
    # app.students.create_girl_pre_k(name="St-3 (Girl)", birthday="04/2015")
    app.students.create_boy_pre_k(name="St-3 (Boy)", birthday="06/2015")
    app.students.create_girl_kindergarten(name="St-4 (Girl)", birthday="08/2014")
    # app.students.create_boy_kindergarten(name="St-4 (Boy)", birthday="05/2014")
    # app.students.create_girl_first_grade(name="St-5 (Girl)", birthday="07/2013")
    app.students.create_boy_first_grade(name="St-5 (Boy)", birthday="02/2013")
    app.students.create_girl_second_grade(name="St-6 (Girl)", birthday="01/2012")
    # app.students.create_boy_second_grade(name="St-6 (Boy)", birthday="05/2011")
...
def test_02_free_teacher_login(app):
    app.free_teacher.open_teacher_login_page("https://eg.qtest.abcmouse.com/teachers")  # Update URL QTEST!
    app.login.to_free_teacher_account(email="ft003@eg.test", password="test123")
