...
def test_01_create_free_teacher_account(app):
    ...
    app.free_teacher.open_teacher_registration_page("https://do.qtest.abcmouse.com/teacher-registration")  # Update URL QTEST!
    app.free_teacher.input_name(fname="AK Test", lname="(Free Teacher)")
    app.free_teacher.submit_email("ft1@do.test")
...
def test_02_free_teacher_login(app):
    app.free_teacher.open_teacher_login_page("https://dv.qtest.abcmouse.com/teachers")  # Update URL QTEST!
    app.login.to_free_teacher_account(email="ft4@do.test", password="test123")
